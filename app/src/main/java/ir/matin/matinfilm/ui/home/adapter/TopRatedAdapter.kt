...
import ir.matin.matinfilm.databinding.ItemPopularBinding
...
class TopRatedAdapter @Inject constructor() :
    ...
    lateinit var binding: ItemTopRatedBinding
    private var items = emptyList<PopularResponse.Result>()
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): PopularViewHolder {
        binding = ItemTopRatedBinding.inflate(LayoutInflater.from(parent.context), parent, false)
